...
const styleLintConfig = path.resolve('./node_modules/@spryker/oryx-for-zed/.stylelintrc');
const esLintConfig = path.resolve('./node_modules/@spryker/oryx-for-zed/.eslintrc.js');
